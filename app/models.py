...
class Product:
    ...
    def import_opinions(self):
        with open("./app/data/opinions/{self.product_id}.json","r",encoding="UTF-8") as json_file:
    ...
    def analyze(self):
        opinions = pd.DataFrame.from_dict([opinion.to_dict() for opinion in self.opinions])
